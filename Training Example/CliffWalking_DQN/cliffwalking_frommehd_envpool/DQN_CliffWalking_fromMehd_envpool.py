...
class DQN_Agent:
    ...
    def select_action(self, state):
        ...
        # Exploration: epsilon-greedy
        if np.random.random() < self.epsilon_max:
            sampled_actions = np.random.randint(0, 4, size=160)
...
class Model_TrainTest:
    def __init__(self, hyperparams):
        ...
        self.env = envpool.make('CliffWalking-v0',  env_type="gym", num_envs=hyperparams["env_num"])
...
with open(f'/data0/FPGA_GYM/python/CliffWalking/cliffwalking_frommehd_envpool/data/reward_buffer_envnum{ENV_NUM}_{curve_idx}.txt', 'w') as f:
    for reward in DRL.REWARD_BUFFER:
        f.write(str(reward) + '\n')
with open(f'/data0/FPGA_GYM/python/CliffWalking/cliffwalking_frommehd_envpool/data/time_buffer_envnum{ENV_NUM}_{curve_idx}.txt', 'w') as f:
    for this_time in DRL.TIME_BUFFER:
        f.write(str(this_time) + '\n')
with open(f'/data0/FPGA_GYM/python/CliffWalking/cliffwalking_frommehd_envpool/data/ave_reward_buffer_envnum{ENV_NUM}_{curve_idx}.txt', 'w') as f:
...
plt.grid(True)
plt.savefig(f'/data0/FPGA_GYM/python/CliffWalking/cliffwalking_frommehd_envpool/data/reward_episode_envnum{ENV_NUM}_{curve_idx}.png')
...
plt.grid(True)
plt.savefig(f'/data0/FPGA_GYM/python/CliffWalking/cliffwalking_frommehd_envpool/data/reward_time_envnum{ENV_NUM}_{curve_idx}.png')
...
plt.grid(True)
plt.savefig(f'/data0/FPGA_GYM/python/CliffWalking/cliffwalking_frommehd_envpool/data/ave_reward_time_envnum{ENV_NUM}_{curve_idx}.png')
...
plt.grid(True)
plt.savefig(f'/data0/FPGA_GYM/python/CliffWalking/cliffwalking_frommehd_envpool/data/ave_reward_episodes_envnum{ENV_NUM}_{curve_idx}.png')
