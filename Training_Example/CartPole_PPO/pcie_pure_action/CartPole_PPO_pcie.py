...
parser.add_argument("curve_idx", nargs='?', default='curve_idx=3', help="Input in the format 'curve_idx=1'")
...
class TrainingMonitor(BaseCallback):
    ...
    def save_data(self, curve_idx):
        base_path = '/data0/FPGA_GYM/python/CartPole_PPO_4000/pcie_pure_action/data'
